 ...
 */
// todo:add wechat hbcc hbcg test
...
class UserAgent {
    ...
    getBrowser(string) {
        switch (true) {
        case UserAgent.browsers.Hbcg.test(string):
            this.agent.isHbcg = true;
            return 'Hbcg';
        case UserAgent.browsers.Hbcc.test(string):
            this.agent.isHbcc = true;
            return 'Hbcc';
        case UserAgent.browsers.weChat.test(string):
    ...
    getBrowserVersion(string) {
        ...
        case 'Hbcg':
            if (UserAgent.versions.Hbcg.test(string)) {
                return RegExp.$1;
            }
            break;
        case 'Hbcc':
            if (UserAgent.versions.Hbcc.test(string)) {
                return RegExp.$1;
            }
            break;
        case 'weChat':
            if (UserAgent.versions.weChat.test(string)) {
                return RegExp.$1;
            }
            break;
        case 'Edge':
    ...
    getOS(string) {
        ...
        case UserAgent.os.OSXSierra.test(string):
            this.agent.isMac = true;
            return 'macOS Sierra';
