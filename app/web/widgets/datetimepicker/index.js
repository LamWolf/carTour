...
class DateTimePicker {
    ...
    _renderIscroll() {
        ...
        //   if (lis.eq(this.currentPage.pageY + 2).length > 0 && (this.currentPage.pageY + 2) <= (lis.length - 3)) {
    ...
    bindEvent() {
        ...
        document.addEventListener('touchmove', this._preventDefault, false);
    }
