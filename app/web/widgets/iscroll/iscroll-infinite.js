/**
 * Created by Gorden on 2017/5/18.
 */
...
(function(window, document, Math) {
    ...
    IScroll.prototype = {
        ...
        _initInfinite() {
            const el = this.options.infiniteElements;
            ...
            this.on('refresh', function() {
                const elementsPerPage = Math.ceil(this.wrapperHeight / this.infiniteElementHeight);
        ...
        reorderInfinite() {
            const center = -this.y + this.wrapperHeight / 2;

            let minorPhase = Math.max(Math.floor(-this.y / this.infiniteElementHeight) - this.infiniteUpperBufferSize, 0),
            ...
            const cachePhase = Math.floor(minorPhase / this.infiniteCacheBuffer);
        ...
        updateCache(start, data) {
            const firstRun = this.infiniteCache === undefined;
