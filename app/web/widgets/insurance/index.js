...
class Insur {
    constructor(opt) {
        ...
        if (Object.prototype.toString.call(opt.insurInfo) != '[object Object]' || JSON.stringify(opt.insurInfo) === '{}') {
            this.opt.insurInfo = {
                insuranceUserList: [],
                returnTime: this.opt.defaultDate,
                returnFlightNo: '',
            ...
            this.opt.insurInfo.returnTime = opt.insurInfo.returnTime ? opt.insurInfo.returnTime : this.opt.defaultDate;
